	...
	var HeatMapColour = function(array, colour){
		this.map = array;
	...
	/* With thanks to subodhghulaxe on JS Fiddle: http://jsfiddle.net/subodhghulaxe/t568u/ */

	HeatMapColour.prototype.convertHex = function(hex, opacity){
	    hex = hex.replace('#','');
